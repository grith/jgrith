...
*/
  ...
  /*
     Current (October 2006) VOMS ACs always have id-ce-noRevAvail and  Authority Key Identifier Extensions
    ...
    try
    {
      ...
      for( Enumeration n = this_sequence.getObjects() ; n.hasMoreElements() ; )
      {
        ...
        try
        {
          ...
          thisDN = thisDN.concat( "/" + Translate_OID.getString( "" + this_seq.getObjectAt( 0 ) ) + "=" + this_string.getString() ) ;
        }
