...
public class MyProxyUploadDialog extends JDialog {
	...
	public MyProxyUploadDialog(GlobusCredential credential, InitParams params, MyProxy myproxy) {
		this();
	...
	public void initialize(GlobusCredential credential, InitParams params, MyProxy myproxy) {
		...
		if (panel == null) {
			...
			panel.setLayout(new FormLayout(
				...
				new RowSpec[] {
					...
					FormFactory.DEFAULT_ROWSPEC}));
			panel.add(getLabel(), new CellConstraints(2, 2, CellConstraints.RIGHT, CellConstraints.DEFAULT));
			panel.add(getLabel_1(), new CellConstraints(2, 4, CellConstraints.RIGHT, CellConstraints.DEFAULT));
			panel.add(getTextField(), new CellConstraints(4, 2, 3, 1));
			panel.add(getPasswordField(), new CellConstraints(4, 4, 3, 1));
			panel.add(getUploadButton(), new CellConstraints(6, 6, CellConstraints.RIGHT, CellConstraints.DEFAULT));
			panel.add(getCancelButton(), new CellConstraints(4, 6, CellConstraints.RIGHT, CellConstraints.DEFAULT));
		}
		return panel;
	}
	/**
			...
			uploadButton.addActionListener(new ActionListener() {
				public void actionPerformed(final ActionEvent e) {
					...
					if ( username == null || "".equals(username) ) {
						...
						JOptionPane.showMessageDialog(MyProxyUploadDialog.this,
					...
					try {
						MyProxy_light.init(myproxy, proxy, params, passphrase);
					} catch (Exception e1) {
						setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
						JOptionPane.showMessageDialog(MyProxyUploadDialog.this,
