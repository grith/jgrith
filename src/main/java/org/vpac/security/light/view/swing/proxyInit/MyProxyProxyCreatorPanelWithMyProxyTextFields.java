...
public class MyProxyProxyCreatorPanelWithMyProxyTextFields extends JPanel {
	...
	private static final Logger myLogger = Logger.getLogger(MyProxyProxyCreatorPanelWithMyProxyTextFields.class.getName());
	
	public static final MyProxy DEFAULT_MYPROXY = new MyProxy("myproxy.arcs.org.au", 443);
	public static final Integer[] DEFAULT_PROXY_LIFETIME_VALUES = new Integer[]{1,2,3,7,14,21};
	...
	private DefaultComboBoxModel lifetimeModel = new DefaultComboBoxModel(DEFAULT_PROXY_LIFETIME_VALUES);
	...
	private void myProxyLogin() {
		...
		if ( username == null || "".equals(username) ) {
			...
			JOptionPane.showMessageDialog(MyProxyProxyCreatorPanelWithMyProxyTextFields.this,
		...
		try {
			GSSCredential cred = MyProxy_light.getDelegation(getMyproxy().getHost(), getMyproxy().getPort(), username, passphrase, lifetimeInSecs);
