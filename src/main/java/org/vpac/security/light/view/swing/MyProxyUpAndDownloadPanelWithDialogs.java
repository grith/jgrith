...
public class MyProxyUpAndDownloadPanelWithDialogs extends JPanel implements ProxyInitListener {
	...
	public MyProxyUpAndDownloadPanelWithDialogs() {
		...
		setLayout(new FormLayout(
			...
			new RowSpec[] {
				...
				FormFactory.RELATED_GAP_ROWSPEC}));
		add(getDownloadButton(), new CellConstraints(2, 2, CellConstraints.LEFT, CellConstraints.DEFAULT));
		add(getUploadButton(), new CellConstraints(4, 2, CellConstraints.RIGHT, CellConstraints.DEFAULT));
		//
	}
			...
			downloadButton.addActionListener(new ActionListener() {
				public void actionPerformed(final ActionEvent e) {
					...
					if ( mpdd.getCred() != null ) {
						fireNewProxyCreated(CredentialHelpers.unwrapGlobusCredential(mpdd.getCred()));
					}
			...
			uploadButton.addActionListener(new ActionListener() {
				public void actionPerformed(final ActionEvent e) {
					...
					try {
						...
						MyProxyUploadDialog mpud = new MyProxyUploadDialog(currentCredential, params, getMyproxy());
						mpud.setVisible(true);

					} catch (MyProxyException e1) {
						JOptionPane.showMessageDialog(MyProxyUpAndDownloadPanelWithDialogs.this,
							    "Error preparing myproxy parameters: "+e1.getLocalizedMessage()+"\n\n. Please contact your administrator.",
							    "MyProxy error",
