...
public class MyProxyDownloadDialog extends JDialog {
	...
	protected JPanel getPanel() {
		if (panel == null) {
			...
			panel.add(getDownloadButton(), new CellConstraints(6, 6, CellConstraints.RIGHT, CellConstraints.DEFAULT));
			...
			downloadButton.addActionListener(new ActionListener() {
				public void actionPerformed(final ActionEvent e) {
					...
					if ( username == null || "".equals(username) ) {
						JOptionPane.showMessageDialog(MyProxyDownloadDialog.this,
					...
					try {
						cred = MyProxy_light.getDelegation(myproxy.getHost(), myproxy.getPort(), username, passphrase, -1);
